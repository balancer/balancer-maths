...
#[test]
fn test_below_surge_threshold_static_swap_fee_case1() {
    ...
    assert_eq!(output_amount, BigInt::from(78522716365403684u64)); // Python reference
}

#[test]
fn test_below_surge_threshold_static_swap_fee_case2() {
    let base_pool_state = BasePoolState {
        pool_address: "0x132F4bAa39330d9062fC52d81dF72F601DF8C01f".to_string(),
        pool_type: "STABLE".to_string(),
        tokens: vec![
    ...
    assert_eq!(output_amount, BigInt::from(452983383563178802u64)); // Python reference
}

#[test]
fn test_above_surge_threshold_uses_surge_fee() {
    let base_pool_state = BasePoolState {
        pool_address: "0x132F4bAa39330d9062fC52d81dF72F601DF8C01f".to_string(),
        pool_type: "STABLE".to_string(),
        tokens: vec![
    ...
    assert_eq!(output_amount, BigInt::from(3252130027531260u64)); // Python reference
}
