...
fn create_test_pool_state() -> StableState {
    let base_pool_state = BasePoolState {
        ...
        token_rates: vec![
            U256::from(1101505915091109485u64),
            U256::from(1016263325751437314u64),
        ],
        balances_live_scaled_18: vec![
            U256::from(1315930484174775273u64),
            U256::from(1307696122829730394u64),
        ],
        swap_fee: U256::from(400000000000000u64),
        aggregate_swap_fee: U256::from(500000000000000000u64),
        total_supply: U256::from(2557589757607855441u64),
...
fn create_test_hook_state() -> StableSurgeHookState {
    StableSurgeHookState {
        ...
        amp: U256::from(1000000u64),
        surge_threshold_percentage: U256::from(20000000000000000u64),
        max_surge_fee_percentage: U256::from(50000000000000000u64),
    }
}
...
fn test_pool_not_surging_unbalanced_add_liquidity_succeeds() {
    ...
    let add_liquidity_input = AddLiquidityInput {
        ...
        max_amounts_in_raw: vec![U256::from(10000000000u64), U256::from(10000000000u64)],
        min_bpt_amount_out_raw: U256::ZERO,
    ...
    assert_eq!(result.bpt_amount_out_raw, U256::from(20644492894u64));
    assert_eq!(
        result.amounts_in_raw,
        vec![U256::from(10000000000u64), U256::from(10000000000u64),]
    );
}
...
fn test_pool_not_surging_single_token_exact_out_add_liquidity_succeeds() {
    ...
    let add_liquidity_input = AddLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_amounts_in_raw: vec![U256::from(10000000000u64), U256::ZERO],
        min_bpt_amount_out_raw: U256::from(10000000000u64),
    ...
    assert_eq!(result.bpt_amount_out_raw, U256::from(10000000000u64));
    assert_eq!(
        result.amounts_in_raw,
        vec![U256::from(9314773070u64), U256::ZERO]
    );
}
...
fn test_pool_not_surging_proportional_remove_liquidity_succeeds() {
    ...
    let remove_liquidity_input = RemoveLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_bpt_amount_in_raw: U256::from(100000000000000000u64),
    ...
    assert_eq!(result.bpt_amount_in_raw, U256::from(100000000000000000u64));
    assert_eq!(
        result.amounts_out_raw,
        vec![
            U256::from(46710576781505052u64),
            U256::from(50311781860935300u64),
        ]
    );
}
...
fn test_pool_not_surging_single_token_exact_in_remove_liquidity_succeeds() {
    ...
    let remove_liquidity_input = RemoveLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_bpt_amount_in_raw: U256::from(10000000000u64),
        min_amounts_out_raw: vec![U256::ONE, U256::ZERO],
    ...
    assert_eq!(result.bpt_amount_in_raw, U256::from(10000000000u64));
    assert_eq!(
        result.amounts_out_raw,
        vec![U256::from(9311058836u64), U256::ZERO]
    );
}
...
fn test_pool_not_surging_single_token_exact_out_remove_liquidity_succeeds() {
    ...
    let remove_liquidity_input = RemoveLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_bpt_amount_in_raw: U256::from(10000000000u64),
        min_amounts_out_raw: vec![U256::from(10000000u64), U256::ZERO],
    ...
    assert_eq!(result.bpt_amount_in_raw, U256::from(10739922u64));
    assert_eq!(
        result.amounts_out_raw,
        vec![U256::from(10000000u64), U256::ZERO]
    );
}
...
fn test_pool_surging_unbalanced_add_liquidity_throws() {
    ...
    let add_liquidity_input = AddLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_amounts_in_raw: vec![U256::from(10000000u64), U256::from(100000000000000000u64)],
        min_bpt_amount_out_raw: U256::ZERO,
        kind: AddLiquidityKind::Unbalanced,
    };
...
fn test_pool_surging_single_token_exact_out_add_liquidity_throws() {
    ...
    let add_liquidity_input = AddLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_amounts_in_raw: vec![U256::from(100000000000000000u64), U256::ZERO],
        min_bpt_amount_out_raw: U256::from(100000000000000000u64),
        kind: AddLiquidityKind::SingleTokenExactOut,
    };
...
fn test_pool_surging_single_token_exact_out_remove_liquidity_throws() {
    ...
    let remove_liquidity_input = RemoveLiquidityInput {
        pool: "0x950682e741abd1498347a93b942463af4ec7132b".to_string(),
        max_bpt_amount_in_raw: U256::from(100000000000000000u64),
        min_amounts_out_raw: vec![U256::from(100000000000000000u64), U256::ZERO],
        kind: RemoveLiquidityKind::SingleTokenExactOut,
    };
